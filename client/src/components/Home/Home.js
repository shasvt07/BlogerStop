...
const Home = () => {
  ...
  return (
    ...
    <div>
      ...
      <div className="collapse collapse-horizontal" id="collapseExample" style={{width:'27%', position:'absolute', zIndex:1}}>
        <Chat socket={socket} username={user?.result.name} email={user?.result.email} room={"12345"}/>
      </div>
